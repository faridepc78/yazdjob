 ...
 تایید شماره موبایل
            ...
            <div class="me-alert-form-card card-body">
                ...
                <div class="me-alert-form-error me-confirm-error btn btn-outline-danger my-2 w-100 me-display-none me-font-Iran13 Iran14 float-right"> کد تایید یزد جاب معتبر نیست</div>
                <div class="me-alert-form-resend-success btn btn-outline-success my-2 w-100 me-display-none me-font-Iran13 Iran14 float-right"> کد تایید یزد جاب مجدد ارسال شد</div>
                ...
                <form id="" class="me-alert-form-form">
                    ...
                    <div class="form-group">
                        <a class="me-alert-form-send-success me-confirm-success my-2 btn btn-outline-success text-success  text-center float-right w-100 me-font-Iran13 Iran14 float-right">کد تایید یزد جاب از طریق پیامک برای شما ارسال شد.</a>
                        <input id="input-login-password" class="me-alert-form-input-password form-control col-md-6 mr-auto ml-auto Iran15 me-input-password" type="text" placeholder="کد تایید یزد جاب...">
                    </div>
