            ...
            <div class="col-md-8 me-margin-top">
                ...
                <div class="card">
                    ...
                    <div class="card-body px-4">
                        ...
                        <div class="me-confirm-error btn btn-outline-danger my-2 me-font-Iran12 Iran14 fw-600 w-100 me-display-none float-right"> کد تایید یزد جاب معتبر نیست</div>
                        ...
                        <div class="me-confirm-success btn btn-outline-success my-2 w-100 me-font-Iran12 Iran14 fw-600 me-display-none float-right"> کد تایید یزد جاب از طریق پیامک برای شما ارسال شد</div>
                        ...
                        <form method="POST">
                            ...
                            <div id="div-input-login-password" class="form-group mt-md-3 me-display-none w-100 float-right">
                                <label for="" class="col-md-3 col-form-label text-right float-right Iran14 fw-600 float-right">کد تایید یزد جاب:</label>
