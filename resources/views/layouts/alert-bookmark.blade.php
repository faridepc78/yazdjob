        ...
        <div class="alert alert-info alert-dismissible fade show position-absolute p-5 me-position-absolute-trl-0" role="alert" >
            ...
            <div class="card">
                ...
                <div class="me-alert-form-card card-body">
                    ...
                    <div class="me-confirm-error btn btn-outline-danger mb-2 w-100 me-display-none"> کد تایید یزد جاب معتبر نیست</div>
                    ...
                    <div class="me-confirm-success btn btn-outline-success mb-2 w-100 me-display-none"> کد تایید یزد جاب از طریق پیامک برای شما ارسال شد</div>
                    ...
                    <form method="POST" >
                        ...
                        <div id="div-input-login-password" class="form-group row mt-md-3 me-display-none">
                            <label for="" class="col-md-3 col-form-label text-right float-right Iran14 fw-600">کد تایید یزد جاب:</label>
