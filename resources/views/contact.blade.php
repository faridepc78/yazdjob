...
@section("meta-description")
    <meta name="description" content="{{"راه های ارتباط با یزد جاب-کاریابی اینترنتی در استان یزد از طریق ایمیل تلگرام و فرم انتقادات وپیشنهادات به راحتی امکان پذیر هست."}}">
@stop
